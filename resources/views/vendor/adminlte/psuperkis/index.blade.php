    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                @can('admin.perki.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.perki.create') }}" data-toggle="modal" data-target="#modalLgId" data-modal-title="Tambah Data">
