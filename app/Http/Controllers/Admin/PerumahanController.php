...
class PerumahanController extends Controller
{
    ...
    public function formUploadDokumen($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.perumahans.form-upload-dokumen', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.perumahans.upload-dokumen', compact('perumahan', 'kategoriPsus'));
        }
    }
