...
use App\DataTables\PsuPerkisDataTable;
...
class PsuPerkiController extends Controller
{
    /**
    ...
    public function index(PsuPerkisDataTable $dataTable)
    {
        return $dataTable->render('vendor.adminlte.psuperkis.index');
    }

    public function getData(Request $request)
    {
        $psus = PerumahanModel::orderBy('id', 'DESC')->paginate(20);
        return view('vendor.adminlte.psuperkis.index', compact('psus'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-create', compact('kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.create', compact('kategoriPsus'));
        }
    }
    ...
    public function show($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-show', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.show', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function peta($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-peta', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.peta', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function psu($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-psu', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.psu', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function print($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-print', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.print', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function document($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-document', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.document', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function pdf($id,Request $request)
    {
        ...
        $pdf = PDF::loadView('vendor.adminlte.psuperkis.pdf', compact('perumahan', 'kategoriPsus'))->setOptions(['defaultFont' => 'sans-serif']);
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-edit', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.edit', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function psuDetail($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-psu-detail', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.psu-detail', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function formUploadPeta($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-upload-peta', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.upload-peta', compact('perumahan', 'kategoriPsus'));
        }
    }
    ...
    public function formUploadDokumen($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.psuperkis.form-upload-dokumen', compact('perumahan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.psuperkis.upload-dokumen', compact('perumahan', 'kategoriPsus'));
        }
    }
